...
export const ArrowBottomIcon = ({ className, width = '3rem', height = '3rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const CutIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        fill="currentColor"
        viewBox="0 0 48 48"
...
export const SplitIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const SubIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        fill="currentColor"
        color="#b0b0b4"
...
export const PlusIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        fill="currentColor"
        color="#b0b0b4"
...
export const ArrowBottomIconSolid = ({ className, width = '1.4rem', height = '1.4rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const WarningIcon = ({ className, width = '1.4rem', height = '1.4rem' }) => (
    <svg
        width="18.33"
        height="18.33"
        viewBox="0 0 48 48"
        fill="currentColor"
        xmlns="http://www.w3.org/2000/svg"
        style={{ fill: 'rgb(22, 24, 35)', opacity: '0.34' }}
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
